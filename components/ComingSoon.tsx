          ...
          <div className="absolute inset-0 bg-gradient-to-b from-black/35 to-transparent flex items-center justify-center">
            ...
            >
              ...
              <p className="mt-3 text-sm md:text-base text-white/90 max-w-2xl mx-auto">
                We’re polishing the page — important features and content are on their way.
                Drop your email and we’ll let you know when this page is live.
              </p>
            </motion.div>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div>
                ...
                <p className="mt-4 text-gray-700 text-lg leading-relaxed">
                  ...
                  goes live, leave your email below. No spam — we’ll only notify
                  you when the page is ready.
                </p>
              ...
              <div>
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="mt-4 text-sm text-gray-500">
                    No external services used. Emails are stored in your browser
                    (localStorage) for testing. When ready we can wire this to
                    your mailing service or backend — you tell me where.
                  </div>
                </form>
              </div>
            </div>
